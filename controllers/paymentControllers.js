...
module.exports.ipn = async (req, res) => {
    ...
    if (payment['status'] === 'VALID') {
        const order = await Order.updateOne({ tansaction_id: tran_id}, { status: 'Complete' });
...
module.exports.initPayment = async (req, res) => {
    ...
    // Set the urls
    payment.setUrls({
        success: 'https://mighty-refuge-53283.herokuapp.com/api/payment/success', // If payment Succeed
        fail: 'https://mighty-refuge-53283.herokuapp.com/api/payment/fail', // If payment failed
        cancel: 'https://mighty-refuge-53283.herokuapp.com/api/payment/cancel', // If user cancel payment
        ipn: 'https://mighty-refuge-53283.herokuapp.com/api/payment/ipn' // SSLCommerz will send http post request in this link
    });
